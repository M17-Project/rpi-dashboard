...
echo '<td>'.$gateway_config['Radio']['RXFrequency'].' Hz</td>';
echo '</tr>';
echo '<tr>';
echo '<td>TX frequency</td>';
echo '<td>'.$gateway_config['Radio']['TXFrequency'].' Hz</td>';
echo '</tr>';
echo '<tr>';
echo '<td>TX power</td>';
echo '<td>'.$gateway_config['Radio']['Power'].' dBm</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Freq. correction</td>';
echo '<td>'.$gateway_config['Radio']['FrequencyCorr'].'</td>';
echo '</tr>';
echo '<tr>';
echo '<td>AFC</td>';
echo '<td>'.$gateway_config['Radio']['AFC'].'</td>';
echo '</tr>';
echo '<tr>';
...
echo '<tr>';
echo '<td>Device</td>';
echo '<td>'.$gateway_config['Modem']['Port'].'</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Baudrate</td>';
echo '<td>'.$gateway_config['Modem']['Speed'].'</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Callsign (ID)</td>';
echo '<td>'.$gateway_config['General']['Callsign'].'</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Reflector</td>';
echo '<td>'.$gateway_config['Reflector']['Name'].'</td>';
echo '</tr>';
echo '<tr>';
echo '<td>Module</td>';
echo '<td>'.$gateway_config['Reflector']['Module'].'</td>';
echo '</tr>';
echo '</table>';
?>
